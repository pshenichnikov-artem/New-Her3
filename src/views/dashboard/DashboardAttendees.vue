<template>
  <div v-if="!route.params.id && route.name !== 'dashboard-attendees-create'">
    <AdminDataTable
      :title="t('dashboard.attendees.tableTitle')"
      :columns="columns"
      :items="attendeeApi.attendees"
      :loading="attendeeApi.loading.search"
      :total-count="attendeeApi.totalCount"
      :current-page="pagination.page"
      :page-size="pagination.pageSize"
      :show-add-button="true"
      @update:sort="updateSort"
      @pagination-change="handlePaginationChange"
      @apply-filters="loadAttendees"
      @reset-filters="resetFilters"
      @edit="openEditAttendeeModal"
      @add="openAddAttendeeModal"
    ...
    >
      <template #filters>
        ...
        <TextFilter
          :title="t('filters.attendee.docNumber')"
        ...
        <SelectFilter
          :title="t('filters.attendee.docType')"
        ...
        <DateRangeFilter
          :title="t('filters.attendee.birthDate')"
    ...
    <ConfirmModal
      ...
      :title="t('dashboard.attendees.deleteConfirmTitle')"
      :message="t('dashboard.attendees.deleteConfirmMessage')"
